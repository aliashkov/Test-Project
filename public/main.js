...
var ApiserviceService = /** @class */ (function () {
    ...
    /*Api Service Call to get Product detail by ProductId */
    ApiserviceService.prototype.getProductId = function (product, id) {
        var s = '/view/' + id;
        return this.http.get(s);
    };
    /*Api Service Call to add a product to Cart */
    ApiserviceService.prototype.addCart = function (product, id, id2) {
        var s = '/cart/' + id + '/' + id2;
        return this.http.post(s, product, httpOptions);
    };
    ...
    /*Api Service Call to add a product to wishlist */
    ApiserviceService.prototype.addWish = function (product, id, id2) {
        var s = '/wishlist/' + id + '/' + id2;
        return this.http.post(s, product, httpOptions);
    };
    /*Api Service Call to get All products To display on hompage */
    ApiserviceService.prototype.getProduct = function (product) {
    ...
    ApiserviceService.prototype.deleteProduct = function (products, id, id2) {
        var s = '/bokdel/' + id + '/' + id2;
        return this.http.post(s, products, httpOptions);
    };
    ...
    /*Api Service Call to get min and max price of product  */
    ApiserviceService.prototype.getMinMax = function () {
        var s = '/minmax';
        return this.http.get(s);
    };
    /*Api Service Call to get All product between a specified price range */
    ApiserviceService.prototype.getProductByPrice = function (product, id) {
        var s = '/search/price/' + id;
        return this.http.get(s);
    };
    /*Api Service Call to get All Products by a search Query */
    ApiserviceService.prototype.getProductByQuery = function (product, id) {
        var s = '/search/' + id;
        return this.http.get(s);
    };
    /*Api Service Call to Add a product */
    ApiserviceService.prototype.addProduct = function (product) {
        return this.http.post('/addproduct', product, httpOptions);
    };
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["Title"], _apiservice_service__WEBPACK_IMPORTED_MODULE_10__["ApiserviceService"]],
...
var BodyComponent = /** @class */ (function () {
    ...
    BodyComponent.prototype.ngOnInit = function () {
        ...
        this.apiservice.getProduct(this.products).subscribe(function (products) {
    ...
    BodyComponent.prototype.search = function (query) {
        var _this = this;
        this.apiservice.getProductByQuery(this.products, query).subscribe(function (products) {
            _this.products = products;
        });
    };
    BodyComponent.prototype.sortPrice = function (query) {
        var _this = this;
        this.apiservice.getMinMax().subscribe(function (products) {
            _this.apiservice.getProductByPrice(_this.products, query).subscribe(function (products) {
                _this.products = products;
            });
        });
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(apiservice, titleService) {
        this.apiservice = apiservice;
        this.titleService = titleService;
        this.i = {};
        this.j = 0;
        this.navbarOpen = false;
        this.titleService.setTitle('[||\|] ProductShare | Liashkov');
    }
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_apiservice_service__WEBPACK_IMPORTED_MODULE_1__["ApiserviceService"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["Title"]])
    ], HeaderComponent);
    ...
    SellComponent.prototype.addUser = function (frm) {
        ...
        if (frm.value.authorName == '' || frm.value.condition == "" || frm.value.actualPrice == "" || frm.value.resellPrice == "" || this.user.id == "" || this.selectedFile == undefined) {
            ...
            this.http.post('/upload', fd).subscribe(function (res) {
                ...
                _this.apiservice.addProduct(product).subscribe(function (product) {
                    alert("Successfully Added Product for sale!!");
                });
            });
        }
    };
...
module.exports = "<app-header></app-header>\n<div class=\"row center\" id=\"product-list\" >      \n    <div class=\"col-sm-8 card well\" style=\"margin-top:5px;\" *ngIf=\"products\">\n        <table class=\"well\" style=\"text-align: center;\">\n            <tr><td rowspan=\"8\" colspan=\"2\"><img src=\"{{products.image}}\" alt=\"image\" style=\"height: 200px; width: 150px;\"></td><td colspan=\"2\"><b> {{products.name}}</b></td></tr>\n            <tr><td colspan=\"2\">By : {{products.authorName}}</td></tr>\n            <tr><td colspan=\"2\"> {{products.condition}} Condition</td></tr>\n            <tr><td colspan=\"2\"><del>₹ {{products.actualPrice}}</del><b> ₹ {{products.resellPrice}}</b></td></tr>  \n            <tr><td colspan=\"2\">Seller Name :{{products.user.fname}} </td></tr>\n            \n              \n            \n                <tr *ngIf=\"user.id == products.user.id; else elseBlock\">\n                  <td colspan=\"2\">You Can Not Buy Your own Product...!!<button class=\"btn btn-danger\" (click)= \"delProduct(products.id)\">Delete Your Post</button> </td>\n                </tr>\n                <ng-template #elseBlock><tr><td colspan=\"2\" > <button class=\"btn btn-primary\" (click)= \"addCart(products.id)\"> Add to Cart</button>\n                    &nbsp;&nbsp;&nbsp;&nbsp;<button class=\"btn btn-primary\" (click)= \"addWish(products.id)\">Add to WishList</button></td></tr>\n              \n            </ng-template>\n            </table>\n    </div>\n    <div class=\"col-sm-7 card well\" style=\"margin-top:5px;\">\n        <table>\n            <tr><td><textarea rows=\"3\" style=\"resize:none\" placeholder=\"Ask seller your query here..!\" [(ngModel)]=\"query\"></textarea></td>\n              </tr><tr>  <td> <button class=\"btn btn-primary\" (click)= \"addMsg(products.id,query)\">Ask Seller</button> </td></tr>\n        </table>\n                  \n                        <table  style=\"text-align:center;\">\n                                <div class=\"well\" *ngFor=\"let messages of message\">\n                                      <tr>\n                                          <td>Posted By : {{ messages.user.fname }}<br> <small>{{ messages.createdAt| date:'longDate' }}</small></td>\n                                            </tr><tr>\n                                          <td><br>Comment :<i> <p>{{messages.text}}</p></i></td>\n                                      </tr>\n                                </div>\n                        </table>\n                  \n       \n    </div>\n\n</div>\n\n\n"
...
var SingleViewComponent = /** @class */ (function () {
    ...
    SingleViewComponent.prototype.ngOnInit = function () {
        ...
        this.router.paramMap.subscribe(function (params) {
            ...
            _this.apiservice.getProductId(_this.products, _this.selected).subscribe(function (products) {
                _this.products = products[0];
                _this.apiservice.getMessage(_this.message, _this.products.id).subscribe(function (message) {
    ...
    SingleViewComponent.prototype.addCart = function (id) {
        ...
        if (this.user == '') {
            ...
            this.apiservice.addCart(this.products, id, this.user.id).subscribe(function (products) {
    ...
    SingleViewComponent.prototype.addWish = function (id) {
        ...
        if (this.user == '') {
            ...
            this.apiservice.addWish(this.products, id, this.user.id).subscribe(function (products) {
                if (products.status == 1) {
    ...
    SingleViewComponent.prototype.delProduct = function (id) {
        var _this = this;
        this.apiservice.deleteProduct(this.products, id, this.user.id).subscribe(function (products) {
            _this.router1.navigateByUrl('/');
        });
    };
...
module.exports = "<app-header></app-header>\n<h1 style=\"text-align: center;\"> This is your WishLIst </h1>\n<div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-sm-12 col-md-12 \">\n                <table class=\"table table-hover\" id=\"show\">\n                    <thead>\n                    <tr class=\"row\">\n                        <th class=\"col-md-4\">PRODUCT NAME</th>\n                        <th class=\"col-md-2\">PRICE</th>\n                        <th class=\"col-md-2\">REMOVE</th>\n    \n                    </tr>\n                    </thead>\n                    <tbody id=\"showTableBody\" ng-init=\"i=0\">\n                    <tr class=\"row\" *ngFor=\"let product of carts\">\n                        <td class=\"col-md-4\">{{product.product.name}}</td>\n                        <td class=\"col-md-2\"><i class=\"fa fa-inr\" aria-hidden=\"true\" ></i>&#8377;  {{product.product.resellPrice}}</td> \n                        <td class=\"col-md-2\"><button class=\"btn btn-warning\" (click)= \"remove(product.id)\" name=\"btn\">REMOVE</button></td>\n                        <td class=\"col-md-2\"><button class=\"btn btn-Success\" (click)= \"addCart(product.product.id)\" name=\"btn\">Add to Cart</button></td>\n                    </tr>\n                    <tr class=\"row\">\n                        <td class=\"col-md-2\">Total If you Bought the New Products :</td>\n                        <td class=\"col-md-2\"><i class=\"fa fa-inr\" aria-hidden=\"true\"></i>&#8377; <del>{{j}}</del> </td>\n                    </tr>\n                    <tr class=\"row\">\n                        <td class=\"col-md-2\">Total you Have to Pay :</td>\n                        <td class=\"col-md-2\"><i class=\"fa fa-inr\" aria-hidden=\"true\"></i>&#8377;  {{i}}</td>\n                    </tr>\n\n                    <tr class=\"row\">\n\n                        <td class=\"col-md-2\">\n                            <a routerLink=\"/\" class='btn btn-primary' style='font-size: 12px;'>\n                                <i class='fa fa-shopping-cart' aria-hidden='true'></i>\n                                Continue Shopping\n                            </a>\n                        </td>\n\n                    </tr>\n                    </tbody>\n                </table>\n            </div>\n        </div>\n    </div>"
